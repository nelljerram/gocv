...
DEBS=unzip wget build-essential cmake curl git libgtk2.0-dev pkg-config libavcodec-dev libavformat-dev libswscale-dev libtbb12 libtbb-dev libjpeg-dev libpng-dev libtiff-dev libdc1394-dev
